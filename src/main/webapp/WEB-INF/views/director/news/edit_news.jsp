	...
	<form:form method="POST" action="${pageContext.request.contextPath}/director/edit/news${newsModel.getId()}"  modelAttribute="newsEditModel" enctype="multipart/form-data">
    	<nav aria-label="breadcrumb">
  		<ol class="breadcrumb menu-ul-nothover">
   			...
   			<%--  <li class="breadcrumb-item"><a href="/director/profile/news${newsModel.id}">ДЕТАЛІ</a></li> --%>
		...
		<div class="form-group row">
			<div class="form-inline">
    			...
    			<div class="form-group">
						<a href="${pageContext.request.contextPath}/director/remove/foto/news${newsEditModel.getId()}" onclick="return deleteFoto()" class="btn btn-info buttonsAll">
