                ...
                <div class="modal-footer">
                	<div class="form-inline">
                    	<div class="form-group">
                      	...
                      	<div class="form-group">
                       		<a href="${pageContext.request.contextPath}/director/remove/user${teacherModel.id}" class="btn btn-danger">
...
<div class="col-md-8">
	<nav aria-label="breadcrumb">
  		<ol class="breadcrumb menu-ul-nothover">
    		<li class="breadcrumb-item"><a href="/director/teachers/1">ВЧИТЕЛІ</a></li>
	...
	<div>
	     <div class="form-inline">
				<div class="form-group">
					<a href="${pageContext.request.contextPath}/director/edit/profile-user${teacherModel.id}" class="btn btn-info buttonsAll">
					<span class="glyphicon glyphicon-pencil"></span> Редагувати </a>
				</div>
				<div class="form-group">
					<a href="${pageContext.request.contextPath}/director/edit/password-user${teacherModel.id}" class="btn btn-info buttonsAll">
				...
				<div class="form-group">	
					<div class="dropdown">
    						...
    						<ul class="dropdown-menu" role="menu" aria-labelledby="menu1">
      							<li role="presentation"><a role="menuitem" tabindex="-1" href="${pageContext.request.contextPath}/director/send-password-to-user${teacherModel.id}">Вчителя</a></li>		
            					<li role="presentation" class="divider"></li>
     							<li role="presentation"><a role="menuitem" tabindex="-1" href="${pageContext.request.contextPath}/director/send-password-to-own-email-user${teacherModel.id}">Директора</a></li>
   							</ul>
  					</div>							
				</div>												
				<div class="form-group">
  ...
  <hr></hr>	  
  	<div class="form-group row">	
		<div class="col-sm-10">
			<c:choose>
				<c:when test="${not empty teacherModel.fotoInBydeCode}">
					<img src="data:image/png;base64, ${teacherModel.fotoInBydeCode}" class="smallImg">
				</c:when>
			</c:choose>
		</div>
	</div>	
	...
	<div class="form-group row">
    	<label class="col-sm-2 control-label">Е-мейл:</label>
    		<div class="col-sm-10">
      			<span>${teacherModel.email}</span>
    		</div>
	</div>
	<div class="form-group row">
    	<label class="col-sm-2 control-label">Логін:</label>
    		<div class="col-sm-10">
      			<span>${teacherModel.login}</span>
    		</div>
	</div>	
	<div class="form-group row">
    	<label class="col-sm-2 control-label">Статус:</label>
    		<div class="col-sm-10">
      			<span>${teacherModel.status}</span>
    		</div>
	</div>
	<div class="form-group row">
		<label class="col-sm-2 control-label">Класне Керівництво:</label>	
			<div class="col-sm-10">
				<c:choose>
					<c:when test="${classModel != null}">${classModel.titleClass}</c:when>
