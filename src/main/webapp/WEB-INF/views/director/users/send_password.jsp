...
<form:form method="POST" action="${pageContext.request.contextPath}/director/send-password-to-own-email-user${emailModel.id}"  modelAttribute="emailModel">
<div class="col-md-8">
	<nav aria-label="breadcrumb">
  		<ol class="breadcrumb menu-ul-nothover">
  			...
  			<c:choose>
  				<c:when test="${role eq rol}">
  					<li class="breadcrumb-item"><a href="/director/profile-teacher${emailModel.id}">ДЕТАЛІ</a></li>
  				</c:when>
  				<c:otherwise>
  					<li class="breadcrumb-item"><a href="/director/profile-student${emailModel.id}">ДЕТАЛІ</a></li>
  				</c:otherwise>
  			</c:choose>
