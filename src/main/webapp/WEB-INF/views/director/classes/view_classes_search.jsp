...
<div class="form-inline justify-content-between">
	...
	<div class="form-group">
			<form:form action="${pageContext.request.contextPath}/director/classes/1" method="get" class="form-inline">
				<button type="submit" class="btn btn-default buttonsAll">
...
<c:url var="firstUrl" value="${pageContext.request.contextPath}/director/search/classes/1" />
<c:url var="lastUrl" value="${pageContext.request.contextPath}/director/search/classes/${classesList.totalPages}" />
<c:url var="prevUrl" value="${pageContext.request.contextPath}/director/search/classes/${currentIndex-1}" />
<c:url var="nextUrl" value="${pageContext.request.contextPath}/director/search/classes/${currentIndex+1}" />
<ul class = "pagination pagination-sm">
	...
	<c:forEach var="i" begin="${beginIndex}" end="${endIndex}">
		<c:url var="pageUrl" value="${pageContext.request.contextPath}/director/search/classes/${i+1}" />
		<c:choose>
