...
<div class="col-md-8">
		<form:form method="POST" action="${pageContext.request.contextPath}/teacher/group/edit/profile${groupAddRequest.idGroup}/add-students/search/1">
	...
	<div class="form-inline justify-content-between">
		<div class="form-group pull-right">
			<div class="form-group">
					<form:form action="${pageContext.request.contextPath}/teacher/group/edit/profile${groupAddRequest.idGroup}/add-students/search/1" method="post" class="form-inline" modelAttribute="filterModel">
					<div class="form-group">
			...
			<div class="form-group">
				<form:form action="${pageContext.request.contextPath}/teacher/group/edit/profile${groupAddRequest.idGroup}/add-students/1" method="get" class="form-inline">
					<button type="submit" class="btn btn-default buttonsAll">
...
<div>
<form:form method="POST" action="${pageContext.request.contextPath}/teacher/group/edit/profile${groupAddRequest.idGroup}/add-students/${currentIndex}" modelAttribute="groupAddRequest">
		<div class="form-group">
			<button class="btn btn-primary buttonsAll" type="submit">
			<span class="glyphicon glyphicon-plus"></span> Додати вибраних </button>
		</div>
