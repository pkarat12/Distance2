...
<div class="form-inline justify-content-between">
	<div class="form-group">
		<a href="${pageContext.request.contextPath}/teacher/add-video-youtube-task" class="btn btn-info buttonsAll">
			<span class="glyphicon glyphicon-plus"></span> Додати </a>
	</div>
	<div class="form-group pull-right">
	<div class="form-group">
			<form:form action="${pageContext.request.contextPath}/teacher/video-youtube-tasks/search/1" method="get" class="form-inline" modelAttribute="filterModel">
	...
	<div class="form-group">
			<form:form action="${pageContext.request.contextPath}/teacher/video-youtube-tasks/1" method="get" class="form-inline">
				<button type="submit" class="btn btn-default buttonsAll">
...
<div>
	...
	<tr>
		<td style="width:40%">Заголовок</td>
		<td style="width:60%">Опис</td>
	</tr>
	</thead> 
	<tbody>
		<c:forEach items="${taskList}" var="one">
			<tr onclick="openWin('${pageContext.request.contextPath}/teacher/video-youtube-task-profile${one.idTask}')" >
...
<c:url var="firstUrl" value="${pageContext.request.contextPath}/teacher/video-youtube-tasks/1" />
<c:url var="lastUrl" value="${pageContext.request.contextPath}/teacher/video-youtube-tasks/${pageModel.totalPages}" />
<c:url var="prevUrl" value="${pageContext.request.contextPath}/teacher/video-youtube-tasks/${currentIndex-1}" />
<c:url var="nextUrl" value="${pageContext.request.contextPath}/teacher/video-youtube-tasks/${currentIndex+1}" />
<ul class = "pagination pagination-sm">
	...
	<c:forEach var="i" begin="${beginIndex}" end="${endIndex}">
		<c:url var="pageUrl" value="${pageContext.request.contextPath}/teacher/video-youtube-tasks/${i+1}" />
		<c:choose>
