...
<div class="col-md-8">
	...
	<form:form method="POST" action="${pageContext.request.contextPath}/teacher/course/add" modelAttribute="requestModel">
    		...
    		<div class="col-md-12">
     		 	<label class="control-label col-sm-2" for="grade">Рік:</label>
					<form:select class="form-control selectpicker input_border" data-style="btn-primary" path="grade">
						<form:option value="${null}">Виберіть рік</form:option>
