...
<div class="form-inline justify-content-between">
	<div class="form-group">
		<a href="${pageContext.request.contextPath}/teacher/add_news" class="btn btn-info buttonsAll">
			<span class="glyphicon glyphicon-plus"></span> Додати </a>
	</div>
	<div class="form-group pull-right">
	<div class="form-group">
			<form:form action="${pageContext.request.contextPath}/teacher/search/news/1" method="get" class="form-inline">
	...
	<div class="form-group">
			<form:form action="${pageContext.request.contextPath}/teacher/remove_filter/news" method="get" class="form-inline">
				<button type="submit" class="btn btn-default buttonsAll">
...
<div>
	...
	<tbody>
		<c:forEach items="${newsListByPageSize}" var="newOne">
			<tr onclick="openWin('${pageContext.request.contextPath}/teacher/profile/news${newOne.id}')" >
...
<c:url var="firstUrl" value="${pageContext.request.contextPath}/teacher/news/1" />
<c:url var="lastUrl" value="${pageContext.request.contextPath}/teacher/news/${newsList.totalPages}" />
<c:url var="prevUrl" value="${pageContext.request.contextPath}/teacher/news/${currentIndex-1}" />
<c:url var="nextUrl" value="${pageContext.request.contextPath}/teacher/news/${currentIndex+1}" />
<ul class = "pagination pagination-sm">
	...
	<c:forEach var="i" begin="${beginIndex}" end="${endIndex}">
		<c:url var="pageUrl" value="{pageContext.request.contextPath}/teacher/news/${i+1}" />
		<c:choose>
