                ...
                <div class="modal-footer">
                	<div class="form-inline">
                    	<div class="form-group">
                      	...
                      	<div class="form-group">
                       		<a href="${pageContext.request.contextPath}/teacher/remove/news${newsModel.getId()}" class="btn btn-danger">
...
<div class="col-md-8">
	<nav aria-label="breadcrumb">
  		<ol class="breadcrumb menu-ul-nothover">
    		<li class="breadcrumb-item"><a href="/teacher/news/1">НОВИНИ</a></li>
	...
	<div>
	     <div class="form-inline">
				<div class="form-group">
					<a href="${pageContext.request.contextPath}/teacher/edit/news${newsModel.getId()}" class="btn btn-info buttonsAll">
